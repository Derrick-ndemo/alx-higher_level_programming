...
Javascript is used for many things. Here, you will use Javascript for 2 reasons:
	- Scripting (Same as you did with python).
	- Web front-end

![Javascript Meme](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/303/Javascript-535.png.jpeg)
